			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "406eb2ba-e3c9-9eb0-3488-3454fbecc5dd",
							"code": "PDS_UsrPriceUSD",
							"caption": "#ResourceString(PDS_UsrPriceUSD)#",
							"dataValueType": 32
						},
						{
							"id": "12524176-08e2-b5e6-cdfc-75ed86986415",
							"code": "PDS_UsrType",
							"caption": "#ResourceString(PDS_UsrType)#",
							"dataValueType": 10
						},
						{
							"id": "594d4be8-5240-8415-98cc-250e787d68ab",
							"code": "PDS_UsrOfferType",
							"caption": "#ResourceString(PDS_UsrOfferType)#",
							"dataValueType": 10
						},
						{
							"id": "10f0867f-7774-5742-52d2-2bffc64206cc",
							"code": "PDS_UsrArea",
							"caption": "#ResourceString(PDS_UsrArea)#",
							"dataValueType": 32
						},
						{
							"id": "3e1420e4-deef-232c-0654-114996dfdac2",
							"code": "PDS_UsrComment",
							"caption": "#ResourceString(PDS_UsrComment)#",
							"dataValueType": 28
						},
						{
							"id": "6cb25adc-f8b5-503f-18d6-07aba703032e",
							"code": "PDS_CreatedBy",
